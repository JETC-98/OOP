...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        AdminDevice deviceAdmin = new AdminDevice();

        deviceAdmin.addDevice(light1);
        deviceAdmin.addDevice(ac1);
        deviceAdmin.addDevice(tv2);
        deviceAdmin.addDevice(ac2);

        deviceAdmin.printDevices();
        deviceAdmin.turnedOnDevicesNum();

        //deviceAdmin.switchDevicesRoom(lowRooms[0].getDevices(), true);
        //deviceAdmin.turnedOnDevicesNum();

        deviceAdmin.devicesTypeNum();
    }
